  ...
  return (
      ...
      <header className="fixed top-0 bg-[#6B1C27] w-full h-[82px] flex text-[#fbf7f5] z-[100]">
        <div className="px-4 sm:px-6 lg:px-8 w-full">
          <nav className=" w-full flex items-center h-full z-50 md:justify-center lg:justify-end ">
            <ul className="flex items-center space-x-8 text-lg w-full font-semibold text-inherit justify-evenly md:justify-evenly md:text-lg lg:justify-end">
              ...
              <button onClick={scrollToSection(orderNowRef)} 
                className="cursor-pointer bg-[#F7F6F3] text-[#2B2B2B] font-bold text-md rounded h-[30px] w-[110px] flex items-center justify-center hover:bg-[#EDEBE8] transition-colors duration-300 
                md:text-lg md:h-[40px] md:w-[150px] lg:text-lg lg:h-[40px] lg:w-[150px]"
              >Order Now</button>
            </ul>
          </nav>
        </div>
